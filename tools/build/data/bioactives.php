...
return [
    ...
    [
        ...
        'id' => 'PP011',
        'name' => 'Lignans',
        'canonicalName' => 'lignans',
        'aliases' => [],
        'category' => 'Polyphenols',
        'subcategory' => 'Lignans',

        'plainEnglish' =>
            'A group of plant polyphenols found mainly in seeds that support gut health, cardiovascular health and healthy hormone metabolism.',

        'primaryAction' =>
            'Supports cardiovascular health, gut microbiome activity and healthy hormone metabolism.',

        'description' =>
            'Lignans are naturally abundant in flaxseed, sesame seeds and whole grains. They are converted by the gut microbiota into enterolignans, which contribute to antioxidant activity and support cardiovascular, digestive and hormonal health.',

        'scientificSummary' =>
            'A class of polyphenolic compounds converted by intestinal microbiota into enterolignans that influence antioxidant defence, cardiovascular physiology and oestrogen receptor signalling.',
    ...
    [
        ...
        'canonicalName' => 'avenanthramides',
        'aliases' => [],
        'category' => 'Polyphenols',
        'subcategory' => 'Phenolic Alkaloids',

        'plainEnglish' =>
            'Unique oat polyphenols that support cardiovascular health and healthy inflammatory balance.',

        'primaryAction' =>
            'Supports cardiovascular health and antioxidant defence.',

        'description' =>
            'Avenanthramides are unique polyphenols found almost exclusively in oats. They contribute to the recognised health benefits of oats through antioxidant activity while supporting healthy inflammatory responses and vascular function.',

        'scientificSummary' =>
            'A group of oat-specific phenolic alkaloids exhibiting antioxidant, anti-inflammatory and vasoprotective activity through modulation of oxidative stress and endothelial signalling.',
